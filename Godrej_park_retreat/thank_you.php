...
<head>
	...
	<style>
        ...
        .home{background-color:green;color:white;border-radius:20px;}
	</style>
...
<body>
	...
	<footer class="site-footer" id="footer">
		<p class="site-footer__fineprint" id="fineprint">Godrej Budigere Copyright ©2024 | All Rights Reserved</p>
	</footer>
</body>
</html>